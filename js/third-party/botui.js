...
function bot_ui_ini() {
    ...
    botui.message.add({delay: 800, content: "Hi, there👋"}).then(function () {
        botui.message.add({delay: 1100, content: "我是是 xzh"}).then(function () {
    ...
    var sure = function () {
        ...
        botui.message.add({delay: 1500, content: "我是一个苦逼的程序猿"}).then(function () {
            botui.message.add({delay: 1200, content: "将敲代码看成一种快乐"}).then(function () {
                botui.message.add({
                    delay: 1500,
                    content: "主修 Java,略知 linux,偶尔也搞 HTML/CSS/JavaScript/Spring"
                }).then(function () {
                    botui.message.add({delay: 1800, content: "喜欢玩游戏"}).then(function () {
                        // botui.action.button({
                        //     delay: 1100,
                        //     action: [{text: "为什么叫xzh呢？🤔", value: "why-mashiro"}]
                        // }).then(function (a) {
                        thirdpart()
                        // })
                    })
    ...
    // , thirdpart = function () {
    //     botui.message.add({delay: 1e3, content: "cungudafa是村姑大发的拼音，大发在韩语发音中时很厉害的意思。"}).then(function () {
    //         botui.action.button({delay: 1500, action: [{text: "为什么叫村姑呢？", value: "why-cat"}]}).then(function (a) {
    //             fourthpart()
    //         })
    //     })
    // }, fourthpart = function () {
    //     botui.message.add({delay: 1e3, content: "我的游戏名叫村姑,后来也有人叫我村姑学姐 "}).then(function () {
    //         botui.message.add({delay: 1100, content: "希望自己打游戏很厉害吧，哈哈哈"}).then(function () {
    //             botui.action.button({
    //                 delay: 1500,
    ...
    //     })
    // }, fifthpart = function () {
    //     botui.message.add({delay: 1e3, content: "emmmm,csdn,github,都是cungudafa哦"}).then(function () {
